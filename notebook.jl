...
# ╔═╡ fb2c8d91-44da-47ca-aaed-67d508072daf
begin
	using DataFrames
	using CSV
end

# ╔═╡ ede2df05-63e2-4a01-a208-f1b632c57344
using Plots  # This will install plots

# ╔═╡ 9948a9b5-cc19-4ef5-b4f1-a9c635fdcef6
using PlutoUI


# ╔═╡ 504a78ca-dfa6-11ef-1729-032aacc1487e
println("Hello, World!")


# ╔═╡ 5d961252-eb68-4e5e-92e9-6889511e952d
hello(x) = println("Hello, $(x)!")

# ╔═╡ 9edc8af7-c3ca-49b7-9ebf-4b4fcf1ef4c7
hello("Stackie")

# ╔═╡ 1dd8c403-3c56-4426-aa7a-3e6fe7924690
df = CSV.read("WHO-COVID-19-global-data.csv", DataFrame)


# ╔═╡ 46acb182-7d37-4b6d-8796-aeae18db13c8
df.Country_code === df[!, "Country_code"]


# ╔═╡ 7a2e8a87-afa1-4775-b6d4-cb64cd641f0c
equals_sg(x::AbstractString) = x == "SG"


# ╔═╡ 3212277d-5fb8-41d9-b290-04aaa834ace0
sg_data = filter(:Country_code => equals_sg, df)


# ╔═╡ 2cc47c84-894f-4baa-9731-f8c3994a598b
dates = sg_data[!, "Date_reported"]

# ╔═╡ d1476531-1862-4f21-a16f-ce0ea274667f
cumulative_cases = sg_data[!, "Cumulative_cases"]

# ╔═╡ 48a17f51-9f05-4ade-ada8-3742d8f959a1
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)


# ╔═╡ ebf92216-fc88-451e-a290-d2e93d3aea29
...
# ╔═╡ 33fe2736-89e0-4f6b-b203-b84dd5ba00b7
@bind slider_value Slider(0:10:1000)


# ╔═╡ ad3139f6-3494-4518-9f6a-cfaa2ea4c608
md"""
### Slider Value Now At $(slider_value)
"""

# ╔═╡ a71a96c8-cde8-458f-b308-7f6096317e8a
@bind date_slider_index Slider(1:length(dates))


# ╔═╡ 35a9ba72-c3d0-4327-bd88-aff69db193f5
md"""
### The date is now $(dates[date_slider_index])
"""

# ╔═╡ d777628e-200b-4723-af9a-e5397cee9f02
